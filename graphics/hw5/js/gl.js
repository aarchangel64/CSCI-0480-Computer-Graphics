...
export { shaderProgram, initGL, drawScene };


async function shaderProgram(gl, vertFile, fragFile) {
  ...
  // setup GLSL program
  return twgl.createProgramInfo(gl, [vertSource, fragSource]);
}
...
function drawScene(gl, deltaTime, lightCol, sData, cube, cM, mats) {
  ...
  gl.uniform1iv(pos("uMats"), mats);

  gl.uniform1i(pos("uTex"), 0);
